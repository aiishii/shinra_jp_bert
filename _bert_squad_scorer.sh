...
work_dir=${data_dir}/work/${test_case_str}


echo "EPOCH="${EPOCH}

python regulation_bio.py --predicate_json ../${model_dir}/epoch-${EPOCH}/shinra_${TARGET}_test_results.json --category ${TARGET} --html_dir ${data_dir}/html/${TARGET} --prefix ${prefix}
cd ..
